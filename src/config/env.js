...
const env = {
  ...
  payments: {
    ...
    selcom: {
      baseUrl: optional("SELCOM_BASE_URL"),
      apiKey: optional("SELCOM_API_KEY"),
      apiSecret: optional("SELCOM_API_SECRET"),
      vendorId: optional("SELCOM_VENDOR_ID"),
      callbackUrl: optional("SELCOM_CALLBACK_URL"),
    },
